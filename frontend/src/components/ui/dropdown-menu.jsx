...
const DropdownMenuItem = React.forwardRef(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      "transition-colors focus:bg-orange-100 focus:text-orange-900 data-[disabled]:pointer-events-none",
      "data-[disabled]:opacity-50 dark:focus:bg-orange-800 dark:focus:text-orange-50",
      inset && "pl-8",
      className
    )}
    {...props}
