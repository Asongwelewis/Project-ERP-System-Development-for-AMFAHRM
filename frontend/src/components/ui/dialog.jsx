...
export function DialogContent({ className = '', children, ...props }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className={twMerge("relative z-10 w-full max-w-lg rounded-md bg-white dark:bg-white p-4 shadow-lg border border-orange-200 dark:border-orange-800", className)} {...props}>
        {children}
      </div>
    </div>
  );
